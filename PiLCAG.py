...
def keys(bcolor,msg, fsize, fcolor, fx, bw, hp, fy, bh, vp, vo, upd):
   ...
   fx += 2 + hp*bw
   if msg == "Exp Time" or msg == "     eV" or msg == "Cam Angle" or msg == "scale all" or msg == "CAL Time" or msg == "Gain" :
...
oldscene_mode,oldsaturation,oldcolor_temp,oldsharpness,oldAuto_Gain,oldgamma,oldexposure,oldgain,oldminc,oldnscale, oldescale, oldsscale, oldwscale, oldcrop, oldauto_g, oldInterval, oldlog, oldrgbw, oldthreshold, oldgraph, oldthres, oldauto_i, oldplot, oldauto_win, oldauto_t, oldzoom, oldrpibr, oldrpico, oldrpiss, oldrpiexno, oldrpigain, oldrpiev, oldcls, oldcon_cap, oldphoto, oldptime, oldpcount, oldrpired, oldrpiblue, oldhist, oldnr, olddecN, olddecS, oldnsi, oldewi = scene_mode,saturation,color_temp,sharpness,Auto_Gain,gamma,exposure, gain,minc,nscale, escale, sscale, wscale, crop, auto_g, Interval, log, rgbw, threshold, graph, thres, auto_i, plot, auto_win, auto_t, zoom, rpibr, rpico, rpiss, rpiexno, rpigain, rpiev, cls, con_cap, photo, ptime, pcount, rpired, rpiblue, hist, nr, decN, decS, nsi, ewi
