...
To work with RaspiOS based on TRIXIE, using libcamera (NOT raspistill/raspivid).
...
Install latest RaspiOS based on Bullseye or BOOKWORM (tested with FULL 32bit and 64bit versions)
